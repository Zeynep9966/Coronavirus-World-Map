...
def toplam_vaka_sayisi_renk(vaka):
    if vaka < 100000:
        return "green"
    elif vaka < 300000:
        return "white"
...
def toplam_vaka_sayisi_radius(vaka):
    if vaka < 100000:
        return 50000
    elif vaka < 300000:
        return 100000
...
for enlem, boylam, vakalar in zip(enlemler,boylamlar,toplam_vakalar):
    toplam_vaka_haritasi.add_child(folium.Circle(location=(enlem, boylam),
                                                 radius=toplam_vaka_sayisi_radius(vakalar),
                                                 color=toplam_vaka_sayisi_renk(vakalar),
                                                 fill=toplam_vaka_sayisi_renk(vakalar),
                                                 fill_opacity=0.5))
